    ...
    <div className="max-w-6xl mx-auto px-6 relative z-10">
      ...
      <div className="flex justify-center">
        {portfolio.map((project, index) => (
          ...
          >
            <img src={project.image} alt={project.title} className="w-full h-48 object-cover rounded-md mb-6 relative z-10" />
  ...
  >
    <div className="max-w-6xl mx-auto px-6">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-[#7F8C8D] font-['Nunito']">
          ¿Listo para brillar? Cuéntanos tu idea y construyamos algo increíble.
        </p>
      </div>
