...
const faqs = [
  {
    ...
    answer: "Dependiendo de la complejidad, nuestros proyectos suelen completarse entre 1 a 4 semanas. Un catálogo digital básico puede estar listo en 5-7 días, mientras que un e-commerce completo puede tomar 3-4 semanas."
  },
  {
    question: "¿Cuáles son sus precios?",
    answer: "Nuestros precios varían según las necesidades específicas de cada proyecto. Ofrecemos soluciones desde $1500 para landing pages básicas hasta $6000 para e-commerce completos. Contáctanos para recibir una cotización personalizada."
  },
  {
    question: "¿Ofrecen soporte post-lanzamiento?",
    answer: "¡Sí! Incluimos 30 días de soporte técnico gratuito después del lanzamiento. Además, ofrecemos planes de mantenimiento mensual para mantener tu sitio actualizado y funcionando perfectamente."
  },
  {
    question: "¿Cómo es el proceso de pago?",
    answer: "Trabajamos con un sistema de pagos fraccionados: 20% inicial para comenzar, 60% distribuido en 3 pagos durante el desarrollo (20% cada uno), y 20% final al entregar el proyecto. Aceptamos transferencias bancarias y pagos con tarjeta."
  },
  {
    question: "¿Trabajan con empresas de cualquier tamaño?",
    answer: "¡Absolutamente! Trabajamos con emprendedores individuales, pequeñas empresas y grandes corporaciones. Adaptamos nuestras soluciones a las necesidades y presupuesto de cada cliente."
  },
  {
    question: "¿Solo desarrollan en las ciudades mencionadas?",
    answer: "No, trabajamos con clientes de todo el mundo. Gracias a nuestro proceso de trabajo digital y herramientas de comunicación modernas, podemos colaborar eficientemente desde cualquier ubicación."
  }
];
